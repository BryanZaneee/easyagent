---
title: Blacksmith Rickert of Vinheim
url: "https://darksouls.wiki.fextralife.com/Blacksmith+Rickert+of+Vinheim"
categories: ["Catalysts", "Game Progress Route", "Magic", "NPCs", "Sorceries", "Upgrades"]
...
| Blacksmith Rickert of Vinheim | |
| --- | --- |
| rickert of vinheim header2 | |
| Location | New Londo Ruins |
| Voiced by | Adam Sopp |

**Blacksmith Rickert of Vinheim** is a Character in Dark Souls.
...
* When given the Enchanted Ember  found in Darkroot Garden as well as the Large Magic Ember in order to upgrade +5 Magic weapons to (up to) +5 Enchanted weapons or +10 Magic weapons respectively.

###'s Inventory

| Sells | intelligence | Uses | Slots | Cost |
| --- | --- | --- | --- | --- |
| Sorcery | intelligence | Uses | Slots | Cost |
...
* Rickerts name might be in reference to Rickert in Berserk, sharing the same name. They do not share any other characteristics, making them sharing names interesting.
