---
title: Stability
url: "https://darksouls.wiki.fextralife.com/Stability"
categories: ["Shields", "Upgrades"]
---
# Stability
...
Shield Categories‍ | Deflection Level | Parry Type | Upgrades
...
* **Normal** - The most common parrying speed for shields. At 30 FPS, 7 frame parry window, 14-19 frames recovery (14 until able to cancel by dodging, 19 for movement, 17 for other actions)
* **Fast** - The speed of most Small Shields and Standard Shields that weigh less than 3.0 units. At 30 FPS, 7 frame parry window, 10-15 frames recovery (10 until earliest cancel by dodging or RH attack, 15 for movement, 13 for other actions)
* **Special** - An exceedingly rare parry type exclusive to the Buckler, the Target Shield and the Parrying Dagger. At 30 FPS, 8 frame parry window, 12-19 frames recovery (12 until earliest cancel by RH attack, 19 for movement, 17 for other actions)

Most weapons that are capable of parrying have a 7 frame window. Exceptions are thrusting swords, which have 6 parry frames, and the aforementioned parrying dagger's special 8 frame window.
...
* Before upgrading into an elemental path, be aware that some Shields will only provide added resistance to one or two elemental damage types.
  + Effigy Shield - Magic & Fire. Pierce Shield - Fire & Lightning. Spiked Shield - Fire & Lightning. Black Iron Greatshield - Magic only. Eagle Shield - Magic & Fire. Tower Shield - Magic only. Bonewheel Shield - Fire & Lightning.
