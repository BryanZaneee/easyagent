---
title: Quelaag
url: "https://darksouls.wiki.fextralife.com/Quelaag"
categories: ["Bonfire", "Bonfires", "Game Progress Route"]
location: Blighttown
health: "NG: 3,139 / NG+: 6,027"
souls: "NG: 20,000 / NG+: 60,000"
---
# Quelaag
...
**Chaos Witch Quelaag** is a Boss in **Dark Souls**. Quelaag is a half-woman, half-spider demon located in a lair near the bottom of Blighttown. She is one of the daughters of the Witch of Izalith, transformed into a monstrous form by the Flames of Chaos. Her notable siblings include The Fair Lady and Ceaseless Discharge. Quelaag guards the second Bell of Awakening and the entrance to her sister’s domain. You can find her in Quelaag's Domain, situated between Blighttown and the Demon Ruins.

### Chaos Witch Information
...
| --- | --- | --- | --- | --- | --- | --- |
| 255 | 255 | 255 | 255 | 229 | Immune | 205 |
| **Poison** | **Toxic** | **Bleed** |
| Immune | Immune | 110 |

**Note:** Despite her association with Chaos, she does **not** take increased damage from Black Knight weapons.
...
As soon as you enter the boss arena, move immediately to avoid getting cornered near the entrance. Quelaag may leap or charge at you, which can pin you against the entrance and leave you vulnerable to her attacks. It’s generally more effective to focus on attacking her legs rather than her body, as this allows for quicker retreats and helps you avoid getting trapped between her legs and body when she turns or jumps.

You can dodge all three of Quelaag's sword attacks with precise timing. For the first two attacks, dodge to your right to avoid being hit. For the thrust attack, walk forward and to the right to evade it, then use this opportunity to deliver a strong counterattack. Quelaag will typically jump back after this, but if she doesn’t, she may be preparing to use her Fire Wave attack. If you anticipate this, back up quickly and block to absorb some of the damage if you can’t get clear in time.

When she spits lava pools near the sides of the room, it creates more space in the center, making it easier for melee players to avoid her AoE attacks and manage their positioning. Be prepared to switch out of targeting Quelaag when necessary, as her attacks can put you in tight spots, requiring you to flee. Also, watch out for her Lava Rush attack when you get close.

Avoid attacking her from behind, as she has a special AoE attack that can one-shot you from that position. Additionally, you need to keep her human half in sight to anticipate her attacks. The visual cues for her attacks come from her human half, so it’s best to attack her from the sides near her human body to better predict and react to her moves.
